package com.example.alltools.chat_beauty.ui
...
import com.example.alltools.databinding.ActivityChannelBinding
...
class ChannelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cid = checkNotNull(intent.getStringExtra(CID_KEY)) {
            "Specifying a channel id is required when starting com.example.alltools.chat.ui.ChannelActivity"
        }
